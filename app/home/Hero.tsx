    ...
    <>
      ...
      <div className='min-h-[120vh] relative  w-full bg-[var(--primary-color)] flex  flex-col sm:flex-row md:flex-row' style={{ backgroundColor: bg }}>
        ...
        <div className="h-[60vh] w-[100vw]  flex justify-center items-end pb-2.5 sm:w-[50vw] sm:h-[100vh]">
          <Image src='https://images.unsplash.com/photo-1490750967868-58cb75069ed6?auto=format&fit=crop&q=80&w=1000' loading='eager' alt='blooming flowers' height={100} width={100} className='h-[60vh] w-full object-contain sm:h-[80vh] md:w-[60vw]' />
        </div>
